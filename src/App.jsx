...
function App() {
   ...
   const cupones = [
    ...
    { id: 3, code: 'CUPO3', description: 'Por compras mayoreas a $10 reciben un regalo' ,img: 'https://res.cloudinary.com/db8e98ggo/image/upload/v1735998680/PROSESANDO_13_faheei.gif'},
